...
public class LocalizacaoDTO implements Serializable  {
	...
	public LocalizacaoDTO(LocalDoacao localDoacao, Double distancia) {
		super();
		this.localDoacao = localDoacao;
		this.distancia = distancia;
	}
	public LocalDoacao getLocalDoacao() {
		return localDoacao;
	}
	public void setLocalDoacao(LocalDoacao localDoacao) {
		this.localDoacao = localDoacao;
	}
