...
var appSisDoeComunicaSUS =  angular.module('appSisDoeComunicaSUS', [
    'ngRoute',
    "ngResource",
    "ngCookies",
    "angular-jwt",
...
appSisDoeComunicaSUS.factory('httpRequestInterceptor', function ($cookies) {
	  return {
...
appSisDoeComunicaSUS.config(function ($httpProvider) {
